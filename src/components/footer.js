...
const Footer = () => {
    ...
    return (
        <footer >
            <div className='pt-10 p-5 overflow-hidden font-medium flex justify-between md:justify-evenly flex-wrap gap-x-10 flex-shrink-0 mx-auto'>
            ...
            <div className='text-center mt-10 w-4/5 mx-auto py-5'>
                <hr className='h-[2px] border-none bg-gradient-to-r from-black/0 via-black to-black/0 ' />
                <p className='text-sm mt-5'>Copyright 2022 uifry.com all rights reserved</p>
            </div>
        </footer>
    )
}
